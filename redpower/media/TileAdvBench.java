...
public class TileAdvBench extends TileEntity implements IInventory, ISidedInventory
{
    ...
    public boolean onBlockActivated(EntityPlayer var1)
    {
        ...
        {
            var1.openGui(RedPower.instance, 2, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            return true;
        }
    }
    ...
    {
    	//!
        this.blockMetadata = (int)Math.floor((double)(var3.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
    }
